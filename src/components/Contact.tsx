      ...
      <div className="relative mx-auto max-w-8xl px-5 sm:px-8">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`reveal ${isVisible ? 'is-visible' : ''} group relative col-span-1 overflow-hidden rounded-3xl border border-teal-500/30 bg-gradient-to-br from-teal-500/10 to-espresso-800/60 p-8 transition-all duration-500 hover:-translate-y-1.5 hover:border-teal-400/60 hover:shadow-gold-lg lg:col-span-1`}
          >
            ...
            <div className="relative">
              ...
              <h3 className="mt-5 font-serif text-3xl text-cream-50">Telegram</h3>
              ...
              <p className="mt-4 font-mono text-lg text-teal-400">{TELEGRAM_HANDLE}</p>
              <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-cream-50 transition-colors group-hover:text-teal-400">
                Open chat
          ...
          {/* Email card */}
          <div
            className={`reveal ${isVisible ? 'is-visible' : ''} rounded-3xl border border-saffron-500/20 bg-espresso-800/50 p-8 [transition-delay:90ms]`}
          >
            ...
            <h3 className="mt-5 font-serif text-3xl text-cream-50">Email</h3>
            <p className="mt-2 text-sm leading-relaxed text-cream-300">
              For detailed inquiries, wholesale, and press. We reply within 24 hours.
            </p>
            <a
              href="mailto:hello@persiantreasures.shop"
              className="mt-4 inline-block font-mono text-lg text-saffron-300 transition-colors hover:text-saffron-200"
            >
          ...
          {/* Origin card */}
          <div
            className={`reveal ${isVisible ? 'is-visible' : ''} rounded-3xl border border-saffron-500/20 bg-espresso-800/50 p-8 [transition-delay:180ms]`}
          >
            ...
            <h3 className="mt-5 font-serif text-3xl text-cream-50">Our Origin</h3>
            <p className="mt-2 text-sm leading-relaxed text-cream-300">
              Sourced from the saffron fields of Khorasan and the weaving houses of Tabriz, Kashan
              and the Zagros.
            </p>
            <p className="mt-4 font-serif text-xl text-cream-100">Iran · Worldwide Shipping</p>
          </div>
        </div>

        {/* Telegram call-to-action banner */}
        <div className={`reveal ${isVisible ? 'is-visible' : ''} mt-10 flex flex-col items-center justify-between gap-5 rounded-3xl border border-teal-500/25 bg-espresso-900/70 p-7 backdrop-blur sm:flex-row sm:p-9`}>
...
export function Footer() {
  return (
    <footer className="relative border-t border-saffron-500/15 bg-espresso-950">
      ...
      <div className="relative mx-auto max-w-8xl px-5 py-14 sm:px-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-saffron-500/10 pt-7 text-center sm:flex-row sm:text-left">
